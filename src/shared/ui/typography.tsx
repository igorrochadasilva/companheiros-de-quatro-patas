...
const typographyVariants = cva("text-foreground", {
  variants: {
    variant: {
      h1: "font-display scroll-m-20 text-4xl font-extrabold tracking-tight md:text-5xl",
      h2: "font-display scroll-m-20 text-3xl font-semibold tracking-tight md:text-4xl",
